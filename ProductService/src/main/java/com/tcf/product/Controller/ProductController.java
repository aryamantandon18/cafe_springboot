...
@CrossOrigin
@Slf4j   // Enables logging using Lombok. You can use log.info(), log.error() etc. without manually creating a logger.
@RestController
...
public class ProductController {
    ...
    public ResponseEntity<?> updateProduct(   // The <?> is a wildcard — it means the response body can be any type.
